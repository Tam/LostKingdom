class FormatDate {
	...
	static _replaceChars = {
		 ...
		 */
		D: function () {
			return FormatDate._shortDays[this.getDay()];
		},
		 ...
		 */
		l: function () {
			return FormatDate._longDays[this.getDay()];
		},
		 ...
		 */
		F: function () {
			return FormatDate._longMonths[this.getMonth()];
		},
		 ...
		 */
		M: function () {
			return FormatDate._shortMonths[this.getMonth()];
		},
		 ...
		 */
		c: function () {
			return FormatDate.format(this, "Y-m-d\\TH:i:sP");
		},
	 ...
	 * @param {string} format - The format string (see http://php.net/manual/en/function.date.php)
	 * @return {string}
	 */
	static format (date, format) {
		...
		return format.replace(/(\\?)(.)/g, function(_, esc, chr) {
			return (esc === '' && FormatDate._replaceChars[chr])
				? FormatDate._replaceChars[chr].call(date)
				: chr;
		});
	}
...
export default FormatDate.format;
